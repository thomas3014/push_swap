...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/19 14:00:50 by tlefebvr          #+#    #+#             */
/*   Updated: 2022/04/20 11:22:56 by tlefebvr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	while (++i < max_size)
	{
		...
		if ((int)(stack_a->size - max_size + i) >= 0)
			write_n_char(max_size_nbr[0]
				- size_nbr(stack_a->array[stack_a->size
					- max_size + i]), ' ');
		if ((int)(stack_a->size - max_size + i) >= 0)
		...
		if ((int)(stack_b->size - max_size + i) >= 0)
			write_n_char(max_size_nbr[1]
				-size_nbr(stack_b->array[stack_b->size
					- max_size + i]), ' ');
		if ((int)(stack_b->size - max_size + i) >= 0)
